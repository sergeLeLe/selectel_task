...
# TODO: версионирование апи, swagger, индексы, прочитать доку внимательно и заметить нюансы, typing, dataclass, marshmellow (отсутствие валидации), модульность, докерфайл (python-slim), стратегии кэширования, конфигурация, enum, логгирование, мидлвары, обработка ошибок в json, внедрение зависимостей, слои логики, использование SQLAlchemy Core (более прозрачно), модель комментариев, подсос конфигов (перетирование), докеригнор, правильная работа с ошибками, нету тестов, апргейд докерфайла
